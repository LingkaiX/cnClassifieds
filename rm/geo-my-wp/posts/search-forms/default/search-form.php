...
<div class="gmw-form-wrapper gmw-form-wrapper-<?php echo $gmw['ID']; ?> gmw-pt-form-wrapper gmw-pt-default-form-wrapper">
	...
	<form class="form-inline gmw-form gmw-form-<?php echo $gmw['ID']; ?>" name="gmw_form" action="<?php echo $gmw['search_results']['results_page']; ?>" method="get">
		...
		<div class="col-md-3 gmw-taxonomies-wrapper">
			<!-- Display taxonomies/categories --> 
			<?php gmw_pt_form_taxonomies( $gmw, 'div', $class='col-md-3 col-md-offset-2' ); ?>
		</div>
		...
		<?php gmw_form_submit_fields( $gmw, "搜索") ?>
